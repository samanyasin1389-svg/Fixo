...
### وای‌فای مغازه
وقتی کاربر بگوید «وای‌فای را روشن کن» (یا دکمه Wi‑Fi روشن)، گوشی به SSID مغازه (`nibero`) هم وصل می‌شود.
رمز را در `.env` با `SHOP_WIFI_PASSWORD` یا در تنظیمات UI بگذار.
اتصال خودکار با وصل کابل به‌صورت پیش‌فرض خاموش است.
